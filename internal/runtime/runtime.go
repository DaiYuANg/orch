...
type Provider interface {
	...
	Deploy(ctx context.Context, workload deployv1.Workload) error
	Stop(ctx context.Context, workloadName string) error
}
...
func (m *Manager) Deploy(ctx context.Context, workload deployv1.Workload) error {
	...
	return p.Deploy(ctx, workload)
}

func (m *Manager) Stop(ctx context.Context, runtime deployv1.RuntimeKind, workloadName string) error {
	...
	return p.Stop(ctx, workloadName)
}
