...
func BindOrchFlags(fs *pflag.FlagSet, def Config) {
	bindCoreFlags(fs, def)
	bindObservabilityFlags(fs, def)
	bindIngressFlags(fs, def)
	bindDNSFlags(fs, def)
...
func bindCoreFlags(fs *pflag.FlagSet, def Config) {
...
func bindObservabilityFlags(fs *pflag.FlagSet, def Config) {
...
func bindIngressFlags(fs *pflag.FlagSet, def Config) {
...
func bindDNSFlags(fs *pflag.FlagSet, def Config) {
...
func bindSchedulerFlags(fs *pflag.FlagSet, def Config) {
...
func bindClusterFlags(fs *pflag.FlagSet, def Config) {
